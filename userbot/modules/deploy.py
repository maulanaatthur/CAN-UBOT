...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (maspion27/CAN-UBOT)",
        ...
        "INFO - 🐣 CAN-UBOT 🐣: Logged in as 557667062",
        "INFO - 🐣 CAN-UBOT 🐣: Successfully...",
        "919852+00:00 app[worker.1]: 919 - 🐣 CAN-UBOT 🐣 -",
        "INFO - 🐣 CAN-UBOT 🐣 ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
